    ...
    <div class="min-h-screen">
      ...
      <header class="flex items-center justify-between px-6 py-4 sm:px-10">
        <div class="flex items-center gap-2">
          ...
          <span class="text-lg font-black text-[#333D2A]">Sakina <span class="text-[#BC7B3B]">Connect</span></span>
        </div>
      ...
      <section class="mx-auto max-w-5xl px-6 py-10 sm:px-10">
        ...
        <h1 class="text-3xl font-black leading-tight text-[#333D2A] sm:text-5xl">
      ...
      <section class="bg-[#333D2A] px-6 py-14 text-center text-white sm:px-10">
        ...
        <h2 class="mt-2 text-2xl font-black sm:text-3xl">Soutien pour les Pèlerins, Sérénité pour les Familles</h2>
        ...
        <div class="mx-auto mt-8 grid max-w-4xl gap-4 sm:grid-cols-3">
          <div class="rounded-2xl bg-white/5 p-5 text-left">
            ...
            <h3 class="mt-2 font-bold">Contrôle de Sécurité Administratif</h3>
          ...
          <div class="rounded-2xl bg-white/5 p-5 text-left">
            ...
            <h3 class="mt-2 font-bold">Itinéraires et Directives claires</h3>
          ...
          <div class="rounded-2xl bg-white/5 p-5 text-left">
            ...
            <h3 class="mt-2 font-bold">Bouton de Secours SOS</h3>
